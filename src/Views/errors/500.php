...
<head>
    ...
    <title>Error 500 - Datasnap</title>
    ...
    <main class="flex-1 relative">
        ...
        <div class="flex flex-col items-center justify-center h-full -mt-16">
            ...
            <div class="flex flex-col items-center justify-center z-10 text-center px-6">
                <span class="material-icons text-8xl text-red-300 mb-4">warning</span>
                <h1 class="text-6xl font-bold text-gray-800 mb-4">500</h1>
                <h2 class="text-2xl font-medium text-gray-600 mb-4">Error interno del servidor</h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button onclick="window.location.reload()" class="inline-flex items-center px-6 py-3 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors">
                        <span class="material-icons mr-2">refresh</span>
                        Reintentar
                    </button>
                </div>
                <div class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-md max-w-md">
        ...
        <div class="absolute bottom-4 left-1/2 -translate-x-1/2">
            <button class="flex items-center justify-center bg-gray-800 text-white px-8 py-3 rounded-full shadow-lg text-lg">
                Reportar problema
                <span class="material-icons ml-4 bg-gray-600 rounded-full p-1">bug_report</span>
            </button>
        </div>
    </main>
