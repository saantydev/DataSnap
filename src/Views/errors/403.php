...
<head>
    ...
    <title>Error 403 - Datasnap</title>
    ...
    <main class="flex-1 relative">
        ...
        <div class="flex flex-col items-center justify-center h-full -mt-16">
            ...
            <div class="flex flex-col items-center justify-center z-10 text-center px-6">
                <span class="material-icons text-8xl text-orange-300 mb-4">lock</span>
                <h1 class="text-6xl font-bold text-gray-800 mb-4">403</h1>
                <h2 class="text-2xl font-medium text-gray-600 mb-4">Acceso denegado</h2>
                <p class="text-gray-500 mb-6 max-w-md">
                    No tienes permisos para acceder a esta página o recurso.
                    Verifica que has iniciado sesión correctamente.
                </p>
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="/login" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
                ...
                <div class="mt-6 p-4 bg-orange-50 border border-orange-200 rounded-md max-w-md">
                    <div class="flex items-center">
                        <span class="material-icons text-orange-600 mr-2">security</span>
                        <div class="text-left">
                            <p class="text-sm font-medium text-orange-800">¿Por qué veo este error?</p>
                            <p class="text-sm text-orange-700 mt-1">
                                Puede deberse a que no has iniciado sesión, tu sesión ha expirado,
                                o no tienes permisos para acceder a este recurso.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="absolute bottom-4 left-1/2 -translate-x-1/2">
            <button class="flex items-center justify-center bg-gray-800 text-white px-8 py-3 rounded-full shadow-lg text-lg">
                Contactar soporte
                <span class="material-icons ml-4 bg-gray-600 rounded-full p-1">contact_support</span>
            </button>
        </div>
    </main>
