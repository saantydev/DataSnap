...
<head>
    ...
    <title>Datasnap - Recuperar Contraseña</title>
...
<body>
    <main>
        ...
        <div class="panel-2">
            ...
            <h1 class="login-titulo">Recuperar Contraseña</h1>
            ...
            <form class="formulario" method="post">
                ...
                <center>
                    <button type="submit" class="submit-boton">Enviar Link de Recuperación</button>
                </center>
            </form>
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="/login" style="color: #2DACB5; text-decoration: none;">← Volver al login</a>
            </div>
        </div>
    </main>
</body>
